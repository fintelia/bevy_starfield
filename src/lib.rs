...
impl Plugin for StarfieldPlugin {
	fn build(&self, app: &mut App) {
		app.add_systems(Startup, setup).add_plugins(CustomMaterialPlugin);
		bevy::asset::load_internal_asset!(app, STARFIELD_SHADER_HANDLE, "starfield_shader.wgsl", Shader::from_wgsl);
	}
}
